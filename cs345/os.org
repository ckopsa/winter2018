...
* DONE Lab 5
  ...
  #+BEGIN_SRC C++ :tangle /ssh:kopsac@157.201.194.204#215:~/lab5.cpp :results raw
    ...
    int main (int argc, char *argv[])
    {
      ...
      int sleepTime = 1; // defaults
      int producers = 5; // defaults
      int consumers = 5; // defaults
      if (argc == 4)
      {
      ...
      {
        cout << "Only " << argc << " arguments were provided." << endl;
        // return -1;
      }
  ...
  #+RESULTS:
  Only 1 arguments were provided.
